...
describe('WeatherReducer should work correct', () => {
  ...
  test('Weather should be set correctly', () => {
    const result = WeatherReducer(initialState, WeatherActions.setInfo([
      {
        name: '1', icon: WeatherIconVariants.Sun, degrees: 10, id: '1',
      },
      {
        name: '2', icon: WeatherIconVariants.Windy, degrees: -10, id: '2',
      },
      {
        name: '3', icon: WeatherIconVariants.Fog, degrees: 15, id: '3',
      },
      {
        name: '4', icon: WeatherIconVariants.Shower, degrees: 22, id: '4',
      },
    ]));
